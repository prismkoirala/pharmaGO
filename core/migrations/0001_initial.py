# Generated by Django 2.2.10 on 2020-05-07 04:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(default='9818195512', max_length=20, null=True)),
                ('street_address', models.CharField(max_length=100)),
                ('apartment_address', models.CharField(max_length=100)),
                ('city', models.CharField(choices=[('BTM', 'BIRTAMOD'), ('DMK', 'DAMAK'), ('BTB', 'BIRTABAZAR'), ('SNC', 'SANISCHARE')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('BC', 'Baby Care'), ('CP', 'Capsules'), ('OW', 'Outwear')], max_length=2)),
